...
<body>
  ...
  <div class="card">
    ...
    <button class="btn" onclick="location.reload()">Повторить поиск</button>
  </div>
</body>
</html>
)rawliteral";
